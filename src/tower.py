...
class TowerRepresentation(nn.Module):
    def __init__(self, n_channels, v_dim, r_dim=256, pool=True):
        ...
        self.conv1 = nn.Conv2d(n_channels + v_dim, k, kernel_size=2, stride=2)
        ...
        self.conv8 = nn.Conv2d(k, n_channels, kernel_size=1, stride=1)

        self.avgpool  = nn.AvgPool2d(n_channels)
